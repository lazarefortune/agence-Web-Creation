    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <h6>Trouvez la bonne affaire parmi <span class="text-success">{{ $total }}</span> petites annonces sur monboncoin.</h6>
                    </div>
                </div>
            </div>

            <h1>Les Annonces</h1>
            <form action="{{ route('monboncoin.search.index') }}" class="mb-5" method="POST" onsubmit="searchFunction(event)" id="searchForm">
                @csrf
                @method('PATCH')
            ...
            <div id="results">
                ...
                <div class="card mb-3" style="border: 2px solid black;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text"><div class="badge badge-pill badge-light">{{ number_format($ad->price) }} Fcfa</div></p>

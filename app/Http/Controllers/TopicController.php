...
class TopicController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('forum.topics.show', $topic->id);
    }
    ...
    public function destroy(Topic $topic)
    {
        ...
        flash("Votre sujet a bien été supprimé.")->error();

        return redirect()->route('forum.topics.myTopics');
    }
    ...
    public function myTopics()
    {
      ...
      $myTopics = (auth()->user())->topics()->paginate(10);

      return view('forum.topics.myTopics', compact('myTopics'));
    }
}

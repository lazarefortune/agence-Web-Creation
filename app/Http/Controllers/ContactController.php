...
class ContactController extends Controller
{
    ...
    public function index($seller_id, $ad_id)
    {
        ...
        return view('monboncoin.messenger', [
            'seller' => $seller,
            'buyer' => $buyer,
            'ad' => $ad,
        ]);
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('monboncoin.ads.index')->with('success','Votre message a bien été envoyé à ' . getUserName($request->seller_id));
    }
